    ...
    return (
        <footer className='w-full border-t border-leafgreen flex justify-center'>
            <div className='container'>
                ...
                <button onClick={() => scrollToTop()} title='Voltar para o topo' className='w-5 h-5 md:w-6 md:h-6 bg-[url("/assets/icons/arrow.svg")] bg-no-repeat bg-center bg-cover transition-all hover:brightness-75' />
            </div>
        </footer>
    )
}